...
""";
    ...
    public NLQAgent(ChatClient.Builder chatClientBuilder, VectorStore vectorStore, SafeSqlExecutor sqlExecutor, QueryLogRepository logRepository, OpenAiChatModel chatModel) {
...
""".formatted(
                    REFINER_PROMPT
                            ...
                            .replace("{raw_data}", dataString)
            );

            var refinerPromptSpec = chatClient.prompt()
                    .user(mergedRefinerPrompt);
